...
import { Input, Button, MenuItem, Select, Grid, Box, ListItem, Paper, Container, Modal, Typography } from '@material-ui/core';
            ...
            >
                {
                    (
                        <>
                            <Box width='25%' height='25%' p={2} zIndex="modal" position="absolute" top='20%' left="35%">
                                <Paper  elevation={6}>
